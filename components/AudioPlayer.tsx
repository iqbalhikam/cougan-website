...
export function AudioPlayer({ playlist }: AudioPlayerProps) {
  ...
  return (
    <div className={`fixed bottom-4 left-4 z-50 transition-all duration-300 ${isExpanded ? 'w-[28rem]' : 'w-16'} h-16 bg-black/80 backdrop-blur-md border border-white/10 rounded-full overflow-hidden flex items-center shadow-lg group`}>
