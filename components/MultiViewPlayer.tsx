...
export function MultiViewPlayer() {
  ...
  const [streamerData, setStreamerData] = useState(streamers);
          ...
          activeStreamers.map((id) => {
            ...
            return (
              <div key={id} className="relative w-full h-full min-h-[300px] bg-black rounded-lg overflow-hidden border border-zinc-800 group">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
